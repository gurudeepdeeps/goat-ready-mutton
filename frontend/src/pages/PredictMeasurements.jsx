...
import { Ruler, Info, Scale, ShoppingCart, Activity } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-16 grid lg:grid-cols-2 gap-12 items-start">
      <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
        ...
        <p className="text-slate-600 mb-10 text-lg">
          No scale? No problem. Use our biometric formula to estimate live weight and mutton yield from body dimensions.
        </p>
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6 bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-2">Heart Girth (cm)</label>
            <input
              type="number"
              name="heart_girth"
              required
              ...
              placeholder="Measure around chest"
            />
          </div>

          <div>
            <label className="block text-sm font-bold text-slate-700 mb-2">Body Length (cm)</label>
            <input
              type="number"
              name="body_length"
              required
              ...
              onChange={handleChange}
              className="input-field"
              placeholder="Shoulder to tail base"
            />
          </div>
          ...
          <div className="md:col-span-2 pt-4">
            ...
            >
              {loading ? <RefreshCcw className="animate-spin w-5 h-5" /> : 'Run Biometric Analysis'}
            </button>
          </div>
        </form>
        ...
        <div className="mt-12 bg-slate-900 text-white rounded-3xl p-8 relative overflow-hidden group">
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
                <li className="flex gap-3">
                    ...
                    <span>Measure <strong>Heart Girth</strong> right behind the front legs.</span>
                </li>
                <li className="flex gap-3">
                    ...
                    <span>Measure <strong>Body Length</strong> from shoulder point to tail base point.</span>
                </li>
                <li className="flex gap-3">
                    ...
                    <span>Keep the goat standing straight for best accuracy.</span>
                </li>
            </ul>
        </div>
      </motion.div>
        ...
        <AnimatePresence mode="wait">
          {!result ? (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-primary-900 mb-2">Analysis Results</h3>
              <p className="text-primary-700">Calculated weights based on heart girth and body length will appear here.</p>
            </motion.div>
          ) : (
            <motion.div
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-2xl border border-primary-100">
                <div className="flex justify-between items-start mb-12">
                   <div>
                        <div className="text-xs font-black text-primary-600 uppercase tracking-widest mb-1">Estimated Live Weight</div>
                ...
                <div className="bg-slate-50 rounded-2xl p-6 mb-6">
                    <div className="flex justify-between items-center mb-4">
                        <span className="text-slate-500 font-bold uppercase text-xs">Ready Mutton Yield</span>
                    ...
                    <div className="flex justify-between mt-2 text-[10px] font-black uppercase text-slate-400">
                        <span>Liveness</span>
                        <span>{result.result.dressing_percentage}% Mutton</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-orange-50 rounded-xl border border-orange-100 flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-[10px] font-bold text-orange-800 uppercase">Min Range</div>
                    ...
                    <div className="p-4 bg-primary-50 rounded-xl border border-primary-100 flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-[10px] font-bold text-primary-800 uppercase">Confidence</div>
              ...
              <div className="bg-primary-900 text-white p-6 rounded-2xl text-center">
                   <p className="text-sm opacity-60">Result based on <strong>Shaeffer's Formula</strong> adjusted for genetic breed variation.</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
